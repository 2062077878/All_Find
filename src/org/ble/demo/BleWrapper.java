...
public class BleWrapper {
    ...
    /* callbacks called for any action on particular Ble Device  状态改变的回调函数 */
    ...
    //   public boolean flag=false;
        ...
        /*	if(flag==true){
        	...
        	if(status == BluetoothGatt.GATT_SUCCESS) {        		
				...
				mUiCallback.uiSuccessfulWrite(mBluetoothGatt, mBluetoothDevice, mBluetoothSelectedService, characteristic, description,flag);
        	}
        	else {
