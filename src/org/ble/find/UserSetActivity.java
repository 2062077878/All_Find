...
//	private String xString;
	...
	private void getAllAddress(){
		...
		Log.e("标记部分解析设备", allName[0]+" "+allAddress[0]);
		...
		builder.setPositiveButton("确认",new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				new Thread(new Runnable() {
					...
					public void run() {
						//待测试
						/*String theLoc = Get_PostUtil.sendGet("http://youfoundme.sinaapp.com/auth/userList", 
           						"address="+selectAddress+"&location="+"getLocation");	
						String location=Get_PostUtil.parseJSON(theLoc, "location"); 
